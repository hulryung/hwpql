...
- **독립 뷰어 앱** — 더블클릭으로 별도 창에서 HWP 파일 열기, Open Recent · Drag & Drop 지원
- **PDF 내보내기 · 인쇄** — rhwp 네이티브 PDF 렌더로 내보내기(⇧⌘E)와 인쇄(⌘P)
- **줌** — 트랙패드 핀치와 ⌘+ / ⌘− / ⌘0 (0.25×–3.0×)
...
- Swift 측은 `hwp_parse_to_html` / `hwp_get_preview_image` / `hwp_render_pdf` 세 함수만 호출해 SVG 기반 HTML, 임베디드 미리보기 이미지, PDF를 받아옵니다.
